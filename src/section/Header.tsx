const Header = () => {
  return (
    <div className='relative w-full py-10 mb-10'>
      <div className='max-w-[80vw] flex flex-col justify-center items-center text-center w-fit relative'>
        <h1 className="relative text-5xl md:text-8xl font-black italic tracking-tighter bg-linear-to-b from-white to-gray-500 bg-clip-text text-transparent">
            PRIZQUIZ
